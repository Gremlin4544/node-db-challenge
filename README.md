...
Relational databases contain tables and columns and are the more commonly used of database types. Relational databases can hold a large amount of data. SQL is Structured Query Language and it is not a database but it can access, insert, update and delete data from databases. 

- [ ] Why do tables need a `primary key`?
So that there is always a unique identifier for each record/row.

- [ ] What is the name given to a table column that references the primary key on another table.
Foreign key

- [ ] What do we need in order to have a _many to many_ relationship between two tables.
You need a third or intermediary table that has columns that contain the primary keys for the 2 'many' tables.
